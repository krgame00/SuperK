...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--include-anime-lama",
        action="store_true",
        help="also install the optional AnimeLaMa model",
    )
...
def main() -> None:
    args = parse_args()
    if not args.baseline and not args.include_anime_lama:
        raise SystemExit("select --baseline and/or --include-anime-lama")
